      ...
      <div className="mx-auto max-w-5xl rounded-xl bg-space-surface p-4 sm:p-6 shadow-xl border border-space-border">
        ...
        <form className="mb-4 grid grid-cols-2 gap-3 items-end sm:flex sm:flex-wrap">
          ...
          <a
            ...
            className="inline-flex w-full sm:w-auto items-center justify-center rounded-lg border border-space-border bg-white px-3 py-1.5 text-sm font-medium text-space-text-primary hover:bg-space-surface-light"
          >
            ⬇️ CSV (Excel)
          </a>
        </form>
